...
export default defineConfig({
  ...
  env: {
    schema: {
      ...
      SITE_AUTHOR_TITLE: envField.string({ context: 'client', access: 'public', default: 'Backend Developer focused on ASP.NET Core APIs and Application Security' }),
      SITE_AUTHOR_BIO: envField.string({ context: 'client', access: 'public', default: 'Junior Backend Developer with hands-on experience developing secure and scalable RESTful APIs using ASP.NET Core. Specialized in relational database design, JWT authentication, RBAC, and application security testing using Burp Suite.' }),
      SITE_AUTHOR_EMAIL: envField.string({ context: 'client', access: 'public', default: 'AbdallahHijazi2023@gmail.com' }),
      SITE_AUTHOR_LOCATION: envField.string({ context: 'client', access: 'public', default: 'Syria' }),
      SITE_AUTHOR_PHONE: envField.string({ context: 'client', access: 'public', default: '+963 982 720 564' }),
