...
export const siteConfig = {
   ...
   */
  url: getEnv('SITE_URL', 'https://abdallah-hijazi.pages.dev'),
   ...
   */
  title: getEnv('SITE_TITLE', 'Abdallah Ahmad Hijazi | Backend Developer'),
   ...
   */
  description: getEnv('SITE_DESCRIPTION', 'Backend Developer specializing in ASP.NET Core API development, application security, relational databases, JWT authentication, and RBAC.'),
  ...
  author: {
    /** Full name */
    name: getEnv('SITE_AUTHOR_NAME', 'Abdallah Ahmad Hijazi'),
    
    /** Professional title or role */
    title: getEnv('SITE_AUTHOR_TITLE', 'Backend Developer focused on ASP.NET Core APIs and Application Security'),
    
    /** Short biography or professional summary */
    bio: getEnv('SITE_AUTHOR_BIO', 'Backend Developer with hands-on experience developing secure and scalable RESTful APIs using ASP.NET Core. Specialized in relational database design, JWT authentication, RBAC, and application security testing using Burp Suite.'),
    
    /** Contact email address */
    email: getEnv('SITE_AUTHOR_EMAIL', 'AbdallahHijazi2023@gmail.com'),
    
    /** Location (optional, empty string to hide) */
    location: getEnv('SITE_AUTHOR_LOCATION', 'Syria'),
    phone: getEnv('SITE_AUTHOR_PHONE', '+963 982 720 564'),
  },
  ...
  social: {
    /** GitHub profile URL */
    github: getEnv('SOCIAL_GITHUB', 'https://github.com/AbdallahHijazi'),
    
    /** LinkedIn profile URL */
    linkedin: getEnv('SOCIAL_LINKEDIN', 'https://linkedin.com/in/abdallah-hijazi-2287712b3'),
